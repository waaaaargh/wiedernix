...
- `xray` The `allowInsecure` option is no longer supported.
...
- `nextcloud35`: Added for the Nextcloud 35 major release.

  See https://nextcloud.com/blog/nextcloud-hub26-summer/ for more details on the new major version.
